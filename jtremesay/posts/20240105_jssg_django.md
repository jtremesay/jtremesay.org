...
Dans l'épisode [précédent]({% url 'jtremesay:post' 'jssg' %}), j'avais bricolé un [pelican](https://getpelican.com/) du pauvre à truc à base de python + restructuredtext + jinja pour gérer le contenue et vite + typescript pour le front.
...
```markdown
{% verbatim %}
{% vite 'jtremesay/js/main/crankshaft.ts' %}
