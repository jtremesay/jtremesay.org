...
class RaycasterUI {
    ...
    constructor(node: HTMLElement) {
        this.canvas_output = node.querySelector(".raycaster-canvas") as unknown as HTMLCanvasElement;
        this.svg_output = node.querySelector(".raycaster-svg") as unknown as SVGElement;
    }
}
